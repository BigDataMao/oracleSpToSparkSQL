create or replace procedure cf_busimg.P_COCKPIT_BU_ANAL_TARG_RESP_Y(I_MONTH_ID    in varchar2,
  ...
  --模块名称:
  --模块编号:
  --模块描述： CF_BUSIMG.T_COCKPIT_BU_ANAL_TARG_RESP_Y  经营分析-分管部门-经营目标完成情况-按年落地
  ...
  --========================================================================================================================
  v_op_object  VARCHAR2(50) DEFAULT 'P_COCKPIT_BU_ANAL_TARG_RESP_Y'; -- '操作对象';
